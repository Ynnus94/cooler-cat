...
<body>
    <div class="main-container">
        <div class="header">
            <img src="coolercat.webp" alt="CoolerCat" class="header-logo" onerror="this.onerror=null; this.src='coolercat.png';">
            <h1>CoolerCat</h1>
...
if __name__ == '__main__':
    ...
    html_file = 'revision_table.html'
    
    create_html_table(csv_file, html_file)
